...
const MovieDetails = ({ movie, onClose }) => {
  ...
  return (
    ...
    <div onClick={onClose} className='w-full min-h-screen fixed inset-0 bg-black/70 flex flex-col items-center justify-end md:justify-center'>
      ...
      <div onClick={(e) => e.stopPropagation()} className='w-full md:w-[85%] lg:w-[80%] xl:w-[70%] h-[80%] md:h-[60%] xl:h-[70%] md:rounded-2xl overflow-hidden bg-[#161616] overflow-y-auto pb-4'>
        ...
        <div className="relative w-full h-70 md:h-80 flex-shrink-0">
          <img
            src={backdropImg}
            alt={movie?.name}
        ...
        <div className='w-full px-4 py-4 flex flex-col gap-4'>
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-sm md:text-base text-gray-200">
            <div className="flex items-center gap-1 text-gray-200 ">
              <Star className="md:size-5 fill-amber-500 text-amber-500" />
            ...
            <div className="flex items-center gap-1">
              <Calendar className="md:size-5 text-gray-400" />
              <span>Release: {releaseYear}</span>
            </div>
          </div>

          {/* Genres section */}
          <div className="flex flex-col gap-1.5 text-gray-200 text-sm md:text-base">
